...
4. Under **App roles**, define the Karapace roles you need (`schema:read`,
   `schema:write`, `subject:read`, `subject:write`, `config_subject:update`,
   `config_global:update`, `schema:delete`, `subject:delete`). Assign the app's
